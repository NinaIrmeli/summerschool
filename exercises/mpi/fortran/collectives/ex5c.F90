program coll_exer
  ...
  integer :: sendcount(0:n_mpi_tasks-1), displs(0:n_mpi_tasks-1)
  ...
  sendcount=(/1,1,2,4/)
  displs=(/0,1,2,4/) 
  call MPI_gatherv(sendbuf,sendcount(rank),MPI_integer,recvbuf,sendcount,displs,MPI_integer,1,MPI_comm_world,ierr)
